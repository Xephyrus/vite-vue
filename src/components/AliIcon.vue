  ...
  setup() {
    const iconMap = ref<Map<string, string>>(
      new Map([
        ...
        [
          'ali-compute',
          "url('https://img.alicdn.com/tfs/TB1SwmqiODsXe8jSZR0XXXK6FXa-128-2688.png')"
        ],
        [
          'ali-storage',
          "url('https://img.alicdn.com/tfs/TB1C7fPidTfau8jSZFwXXX1mVXa-128-2688.png')"
        ],
        [
          'ali-db',
        ...
        [
          'ali-big-data',
          "url('https://img.alicdn.com/tfs/TB1u12whCslXu8jSZFuXXXg7FXa-128-2688.png')"
        ],
        [
          'ali-ai',
        ...
        [
          'ali-net&cdn',
          "url('https://img.alicdn.com/tfs/TB111c4mz39YK4jSZPcXXXrUFXa-128-2688.png')"
        ],
        ...
        [
          'ali-developer',
          "url('https://img.alicdn.com/tfs/TB1cHirmP39YK4jSZPcXXXrUFXa-128-2688.png')"
        ],
        [
          'ali-iot',
        ...
        [
          'ali-mix-cloud',
          "url('https://img.alicdn.com/tfs/TB1gnuZiipE_u4jSZKbXXbCUVXa-128-2688.png')"
        ],
        [
          'ali-app',
    ...
    return { iconMap, fps, position, timer, onMouseenter, onMouseLeave }
  }
}
</script>
